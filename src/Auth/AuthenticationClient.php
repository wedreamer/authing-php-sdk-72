...
class AuthenticationClient extends BaseClient
{
     ...
     *      $options->appId = '';
     * });
     * // 通过用户池 ID 初始化认证客户端(不推荐使用)
     * $authenticationClient = new AuthenticationClient('userPoolId');
     * @throws
    ...
    public function listAuthorizedResources($namespace, $opts = [])
    {
        ...
        return Utils::formatAuthorizedResources($this->request($param->createRequest()));
    }
