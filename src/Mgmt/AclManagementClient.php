...
class AclManagementClient
{
     ...
     * @throws Exception
     */
    public function allow(string $userId, string $resource, string $action)
    {
    ...
    public function refreshProgrammaticAccessAccountSecret(string $programmaticAccessAccountId, string $programmaticAccessAccountSecret = randomString(32))
    {
    ...
    // TODO: 缺少 enableProgrammaticAccessAccount
